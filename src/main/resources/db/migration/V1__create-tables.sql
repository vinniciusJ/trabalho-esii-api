...
-- Criar tabela de relacionamento entre main_event e event_participant
CREATE TABLE main_event_participant (
                                        ...
                                        CONSTRAINT FK_main_event FOREIGN KEY (main_event_id) REFERENCES main_event,
                                        CONSTRAINT FK_event_participant FOREIGN KEY (event_participant_id) REFERENCES event_participant
);
...
-- Criar tabela de relacionamento entre main_event_action e event_participant
CREATE TABLE main_event_action_participant (
                                               ...
                                               CONSTRAINT FK_main_event_action FOREIGN KEY (main_event_action_id) REFERENCES main_event_action,
                                               CONSTRAINT FK_event_participant_action FOREIGN KEY (event_participant_id) REFERENCES event_participant
);

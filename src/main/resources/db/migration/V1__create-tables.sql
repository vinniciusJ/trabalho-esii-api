...
-- Criar tabela de relacionamento entre participantes e eventos
CREATE TABLE main_event_participant (
                                         event_participant_id BIGINT NOT NULL,
                                         main_event_id BIGINT NOT NULL,
                                         CONSTRAINT PK_event_participant_event PRIMARY KEY (event_participant_id, main_event_id),
                                         CONSTRAINT FK_participant_event FOREIGN KEY (event_participant_id) REFERENCES event_participant,
                                         CONSTRAINT FK_event_event FOREIGN KEY (main_event_id) REFERENCES main_event
);

-- Criar tabela de relacionamento entre participantes e ações
CREATE TABLE main_event_action_participant (
                                          event_participant_id BIGINT NOT NULL,
                                          main_event_action_id BIGINT NOT NULL,
                                          CONSTRAINT PK_event_participant_action PRIMARY KEY (event_participant_id, main_event_action_id),
                                          CONSTRAINT FK_participant_action FOREIGN KEY (event_participant_id) REFERENCES event_participant,
                                          CONSTRAINT FK_action_event FOREIGN KEY (main_event_action_id) REFERENCES main_event_action
);
